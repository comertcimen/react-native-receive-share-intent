...
public class ReceiveShareIntentHelper {

  private Context context;

  public ReceiveShareIntentHelper(Application context){
    ...
    if(Objects.equals(intent.getAction(), Intent.ACTION_SEND)){
      ...
      if (contentUris != null) {
        ...
        for (Uri uri : contentUris) {
          ...
          @SuppressLint("Recycle") Cursor queryResult = contentResolver.query(uri, null, null, null, null);
          queryResult.moveToFirst();
          file.putString("fileName", queryResult.getString(queryResult.getColumnIndex(OpenableColumns.DISPLAY_NAME)));
          file.putString("filePath", filePath);
